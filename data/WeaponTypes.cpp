...
WeaponTypes::WeaponTypes() {
	...
	const std::array<WeaponTypeData, 41> data = {{
		{"ak47"s, L"AK-47"s, WeaponCategory::PRIMARY},
		...
		{"g3sg1"s, L"G3SG1"s, WeaponCategory::PRIMARY},
		...
		{"mac10"s, L"MAC-10"s, WeaponCategory::PRIMARY},
		...
		{"negev"s, L"Negev"s, WeaponCategory::PRIMARY},
		...
		{"sg556"s, L"SG 553"s, WeaponCategory::PRIMARY},
		...
		{"deagle"s, L"Desert eagle"s, WeaponCategory::SECONDARY},
		...
		{"p250"s, L"P250"s, WeaponCategory::SECONDARY},
		...
		{"smokegrenade"s, L"Smoke grenade"s, WeaponCategory::GRENADE}
	}};
