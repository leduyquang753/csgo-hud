...
class EventBus final {
	private:
		...
		std::unordered_map<std::string, std::vector<std::pair<std::function<void(const JSON&)>, DataEventListener*>>>
	...
	public:
		...
		void notifyDataEvent(const std::string &dataPath, const JSON &json) const;
};
